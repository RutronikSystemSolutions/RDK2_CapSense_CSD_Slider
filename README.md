# RDK2 CapSense CSD Slider 

Rutronik Development Kit Programmable System-on-Chip CY8C6245AZI-S3D72 "CapSense CSD Slider" Example. 

This example is demonstrates how to use CapsSense® Slider in CSD mode. 
...
2. Select the directory where **"RDK2_CapSense_CSD_Slider"** resides and click  **Finish**.
